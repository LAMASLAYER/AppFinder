...
(
  CAMPAIGN_ID INT NOT NULL UNIQUE AUTO_INCREMENT,
  NAME VARCHAR(64) NOT NULL,
  GM_ID INT NOT NULL,
...
(
  CHAR_GEAR_ID INT NOT NULL UNIQUE AUTO_INCREMENT,
  CHAR_ID INT NOT NULL,
...
(
  CHAR_SPELL_ID INT NOT NULL UNIQUE AUTO_INCREMENT,
  CHAR_ID INT NOT NULL,
...
(
  CLASS_SKILL_ID INT NOT NULL UNIQUE AUTO_INCREMENT,
  SKILL_ID INT NOT NULL,
  CLASS_ID INT NOT NULL,
...
CREATE TABLE RACES
(
  RACE_ID INT NOT NULL UNIQUE AUTO_INCREMENT,
  NAME VARCHAR(32) UNIQUE NOT NULL,
